...
description: >
  Reviews a diff against the P1–P42 code-pattern catalog (the NON-wire subset): DRY/duplication, consolidation honesty, lazy & missing imports, typing, create/update validator symmetry, tenant scoping, raw-dict→ typed Error, adapter consistency (P17/P42), and process/perf NITs. Invoke per-PR or on a working-tree diff.
---
